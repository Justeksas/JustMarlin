...
// Very similar to Mriscoc's version but with my own touch. Based on latest marlin bugfix branch.
// https://github.com/Justeksas/JustMarlin
...
#define AUTOTEMP
  ...
  #define AUTOTEMP_MIN          210 // Changed by Justeksas
  #define AUTOTEMP_MAX          250 // Changed by Justeksas
  #define AUTOTEMP_FACTOR       0.1f // Changed by Justeksas
 ...
 */
#define HOTEND_IDLE_TIMEOUT // Enabled by Justeksas
#if ENABLED(HOTEND_IDLE_TIMEOUT)
  #define HOTEND_IDLE_TIMEOUT_SEC (10*60)    // (seconds) Time without extruder movement to trigger protection // Changed by Justeksas
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING // Changed by Justeksas
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu  // Enabled by Justeksas
  ...
  #define STATUS_MESSAGE_SCROLLING  // MRiscoC Allow scrolling of large status messages // Enabled by Justeksas

  // Apply a timeout to low-priority status messages
  #define STATUS_MESSAGE_TIMEOUT_SEC 30 // (seconds)  // MRiscoC Enable Status Message Timeout // Enabled by Justeksas
...
#define SET_PROGRESS_MANUALLY // Enabled by Justeksas
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define SD_PROCEDURE_DEPTH 1              // Increase if you need more nested M32 calls // Changed by Justeksas
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_GCODE       true   // Allow turning sorting on/off with LCD and M34 G-code. // Enabled by Justeksas
  ...
  #define LONG_FILENAME_HOST_SUPPORT      // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' // Enabled by Justeksas
  #define LONG_FILENAME_WRITE_SUPPORT     // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol // Enabled by Justeksas
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES           // Scroll long filenames in the SD card menu // Enabled by Justeksas
  ...
  #define BINARY_FILE_TRANSFER // Enabled by Justeksas

  #if ENABLED(BINARY_FILE_TRANSFER)
    // Include extra facilities (e.g., 'M20 F') supporting firmware upload via BINARY_FILE_TRANSFER
    #define CUSTOM_FIRMWARE_UPLOAD // Enabled by Justeksas
  #endif
 ...
 */
#define NO_SD_HOST_DRIVE   // Disable SD Card access over USB (for security). // Enabled by Justeksas
...
#define BABYSTEPPING // Ender configs
  ...
  #define BABYSTEP_WITHOUT_HOMING           // Enabled by Justeksas
  #define BABYSTEP_ALWAYS_AVAILABLE         // Allow babystepping at all times (not just during movement). // Enabled by Justeksas
  ...
  #define BABYSTEP_ZPROBE_OFFSET            // Combine M851 Z and Babystepping // Enabled by Justeksas
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define ARC_P_CIRCLES               // Enable the 'P' parameter to specify complete circles // Enabled by Justeksas
...
#define MIN_STEPS_PER_SEGMENT 4 // Changed by Justeksas
...
#define BUFSIZE 16 // Changed by Justeksas. Buffer size increase for Octoprint.
...
#define TX_BUFFER_SIZE 64 // Changed by Justeksas. Buffer size increase for Octoprint.
 ...
 */
#define EMERGENCY_PARSER // Changed by Justeksas.
...
#define ADVANCED_OK // Changed by Justeksas.
 ...
 */
#define FWRETRACT                           // Enabled by Justeksas.
#if ENABLED(FWRETRACT)
  //#define FWRETRACT_AUTORETRACT             // Override slicer retractions // Changed by Justeksas.
  #if ENABLED(FWRETRACT_AUTORETRACT)
    #define MIN_AUTORETRACT             0.1 // (mm) Don't convert E moves under this length
    #define MAX_AUTORETRACT            10.0 // (mm) Don't convert E moves over this length
  #endif
  #define RETRACT_LENGTH                5   // (mm) Default retract length (positive value) // Changed by Justeksas.
  #define RETRACT_LENGTH_SWAP          13   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE             40   // (mm/s) Default feedrate for retracting // Changed by Justeksas.
  #define RETRACT_ZRAISE              0.2   // (mm) Default retract Z-raise // Changed by Justeksas.
  #define RETRACT_RECOVER_LENGTH        0   // (mm) Default additional recover length (added to retract length on recover)
  #define RETRACT_RECOVER_LENGTH_SWAP   0   // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
  #define RETRACT_RECOVER_FEEDRATE     40   // (mm/s) Default feedrate for recovering from retraction // Changed by Justeksas.
 ...
 */
#define ADVANCED_PAUSE_FEATURE // Changed by Justeksas.
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     20  // (mm/s) Unload filament feedrate. This can be pretty fast. // Changed by Justeksas.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  12  // (mm/s) Load filament feedrate. This can be pretty fast. // Changed by Justeksas.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           90  // (seconds) Time limit before the nozzle is turned off for safety. // Changed by Justeksas.
  #define FILAMENT_CHANGE_ALERT_BEEPS         10  // Number of alert beeps to play when a response is needed.
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.

  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change. // Changed by Justeksas.
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES             // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. // Changed by Justeksas.
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) // Changed by Justeksas
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT // Changed by Justeksas
#endif
 ...
 */
#define NO_WORKSPACE_OFFSETS // Changed by Justeksas
 ...
 */
#define HOST_ACTION_COMMANDS // Changed by Justeksas
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback // Changed by Justeksas
 ...
 */
#define CANCEL_OBJECTS             // Changed by Justeksas
